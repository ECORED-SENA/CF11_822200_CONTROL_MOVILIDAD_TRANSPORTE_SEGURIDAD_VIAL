  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-8(data-aos="fade-left")
        LineaTiempoD.color-acento-contenido
          ...
          p.text-small(numero="2" titulo="Testigo técnico") Cuenta con experticia en una determinada ciencia, técnica o arte, por lo que le está permitido exponer apreciaciones o impresiones personales en el curso de su deposición, siempre que estén, formadas como consecuencia de sus condiciones profesionales o académicas, se relacionen con los hechos objeto del testimonio y contribuyan a mejorar su declaración como prueba testimonial del proceso.
          p.text-small(numero="3" titulo="Testigo perito") Experto en determinada técnica, ciencia, arte o conocimiento especializado, quien previa solicitud conforme con la legislación colombiana, realiza un reconocimiento, examen, estudio o valoración relativo a su área de conocimiento e informa sus actuaciones, observaciones, análisis y resultados en el respectivo informe pericial (por escrito).
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-9(data-aos="fade-left")
        p.mb-0 También es importante conocer la estructura del proceso penal y las actuaciones de quienes participan: el fiscal, la defensa, el ministerio público, el representante de las víctimas y el juez, quien tiene la decisión al final del proceso.
          br
          |Ser claro en los tecnicismos jurídicos es de vital importancia para el perito, ya que una palabra mal relacionada puede significar una cosa diferente a lo que se quiere decir, poniendo en entredicho su idoneidad en el tema, por lo que resulta necesario ser preciso en su voluntad comunicativa o expresar correctamente lo que se quiere decir atendiendo a técnicas de oralidad.
    p.mb-5(data-aos='fade-right') De acuerdo con Pérez (2018), la técnica de la oralidad está integrada por elementos metodológicos que determinan su estructura interna, como se ilustra en la siguiente figura: 
    ...
    .row.justify-content-center.mb-5
      ...
      .col-lg-10(data-aos="fade-left")
        .tarjeta.p-4(style="background-color: #fff6e9")
            p.mb-0 Para concluir, y aplicado al proceso de sustentación del informe pericial, se recomienda entonces al perito conocer muy bien la información, Responder de manera clara, precisa, concisa, con convicción y ostensibilidad todos los cuestionamientos a los que se va a enfrentar, manteniendo la calma, sin incurrir en errores.
